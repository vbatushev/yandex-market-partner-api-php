...
| [**putBidsForCampaign()**](DbsApi.md#putBidsForCampaign) | **PUT** /campaigns/{campaignId}/bids | description |
...
$body = new \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdCancellationAccept(); // \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdCancellationAccept

try {
    $result = $apiInstance->acceptOrderCancellation($campaign_id, $order_id, $body);
    print_r($result);
} catch (Exception $e) {
...
| **body** | **\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdCancellationAccept**|  | |

### Return type

[**\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdCancellationAccept**](../Model/CampaignsCampaignIdOrdersOrderIdCancellationAccept.md)
...
```php
createOutlet($campaign_id, $body): \OpenAPI\Client\Model\CampaignsCampaignIdOutlets
```
...
$campaign_id = 56; // int | Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**.
$body = new \OpenAPI\Client\Model\CampaignsCampaignIdOutlets(); // \OpenAPI\Client\Model\CampaignsCampaignIdOutlets

try {
    $result = $apiInstance->createOutlet($campaign_id, $body);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **campaign_id** | **int**| Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. | |
| **body** | **\OpenAPI\Client\Model\CampaignsCampaignIdOutlets**|  | |

### Return type

[**\OpenAPI\Client\Model\CampaignsCampaignIdOutlets**](../Model/CampaignsCampaignIdOutlets.md)
...
```php
deleteOutlet($campaign_id, $outlet_id): \OpenAPI\Client\Model\CampaignsCampaignIdOutletsOutletId
```
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdOutletsOutletId**](../Model/CampaignsCampaignIdOutletsOutletId.md)
...
```php
getAllOffers($campaign_id, $feed_id, $chunk): \OpenAPI\Client\Model\CampaignsCampaignIdOffersAll
```

Все предложения магазина

Позволяет максимально быстро получить информацию обо всех предложениях магазина, размещенных на Маркете. Возвращает результат в виде сегментов нефиксированного размера.  В ответе на запрос для каждого найденного предложения указывается URL и наименование этого предложения, его цена и валюта, в которой она указана, карточка модели Яндекс Маркета, с которой соотнесено предложение, а также аукционные ставки на него.  Количество запросов к ресурсу, которое возможно выполнить в течение суток, рассчитывается индивидуально и зависит от следующих показателей:  * количество предложений на витрине.  {% note info %}  Количество предложений считается по данным за последние семь дней (не включая сегодня).  Для новых магазинов, еще не разместивших предложения, ограничение равно 0 и пересчитывается на следующий день после размещения первых предложений.  {% endnote %}
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdOffersAll**](../Model/CampaignsCampaignIdOffersAll.md)
...
```php
getCampaignFeedCategories($campaign_id, $page, $page_size): \OpenAPI\Client\Model\CampaignsCampaignIdFeedsCategories
```
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdFeedsCategories**](../Model/CampaignsCampaignIdFeedsCategories.md)
...
```php
getCampaignRegion($campaign_id): \OpenAPI\Client\Model\CampaignsCampaignIdRegion
```
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdRegion**](../Model/CampaignsCampaignIdRegion.md)
...
```php
getCampaignSettings($campaign_id): \OpenAPI\Client\Model\CampaignsCampaignIdSettings
```
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdSettings**](../Model/CampaignsCampaignIdSettings.md)
...
```php
getFeedCategories($campaign_id, $feed_id, $page, $page_size): \OpenAPI\Client\Model\CampaignsCampaignIdFeedsFeedIdCategories
```
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdFeedsFeedIdCategories**](../Model/CampaignsCampaignIdFeedsFeedIdCategories.md)
...
```php
getFeedbackAndCommentUpdates($campaign_id, $page_token, $limit, $from_date): \OpenAPI\Client\Model\CampaignsCampaignIdFeedbackUpdates
```

Новые и обновленные отзывы о магазине

Возвращает новые и обновленные отзывы о магазине на Маркете.  Результаты возвращаются постранично, одна страница содержит не более 20 отзывов. Выходные данные содержат идентификатор следующей страницы.  В течение часа можно отправить не более 100 запросов.
...
$limit = 20; // int | Количество товаров в выходных данных.
$from_date = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | Начальная дата обновления отзывов
...
| **limit** | **int**| Количество товаров в выходных данных. | [optional] |
| **from_date** | **\DateTime**| Начальная дата обновления отзывов | [optional] |

### Return type

[**\OpenAPI\Client\Model\CampaignsCampaignIdFeedbackUpdates**](../Model/CampaignsCampaignIdFeedbackUpdates.md)
...
```php
getModel($model_id, $region_id, $currency): \OpenAPI\Client\Model\ModelsModelId
```
...
[**\OpenAPI\Client\Model\ModelsModelId**](../Model/ModelsModelId.md)
...
```php
getModelOffers($model_id, $region_id, $currency, $order_by_price, $count, $page): \OpenAPI\Client\Model\ModelsModelIdOffers
```
...
[**\OpenAPI\Client\Model\ModelsModelIdOffers**](../Model/ModelsModelIdOffers.md)
...
```php
getOffers($campaign_id, $query, $feed_id, $shop_category_id, $currency, $matched, $page, $page_size): \OpenAPI\Client\Model\CampaignsCampaignIdOffers
```

Предложения магазина

Позволяет фильтровать информацию о предложениях магазина, размещенных на Маркете, и искать предложения по заданному поисковому запросу.  Поиск предложений, размещенных на Маркете, работает по поисковому запросу аналогично поиску Маркета. Результаты возвращаются с использованием пейджера.  В ответе на запрос для каждого найденного предложения указывается URL и наименование этого предложения, его цена и валюта, в которой она указана, карточка модели Маркета, с которой соотнесено предложение, и аукционные ставки на него.  {% note info %}  Из-за особенностей поиска Маркета иногда на последних страницах пейджера фактическое количество результатов оказывается меньше количества, указанного ранее на предыдущих страницах.  В связи с этим настоятельно рекомендуется анализировать содержимое параметра pager для каждой полученной страницы.  {% endnote %}  Количество запросов к ресурсу, которое возможно выполнить в течение суток, рассчитывается индивидуально и зависит от следующих показателей:  * количество предложений на витрине.  {% note info %}  Количество предложений считается по данным за последние семь дней (не включая сегодня).  Для новых магазинов, еще не разместивших предложения, ограничение равно 0 и пересчитывается на следующий день после размещения первых предложений.  {% endnote %}
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdOffers**](../Model/CampaignsCampaignIdOffers.md)
...
```php
getOrders($campaign_id, $status, $substatus, $from_date, $to_date, $supplier_shipment_date_from, $supplier_shipment_date_to, $dispatch_type, $fake, $has_cis, $only_waiting_for_cancellation_approve, $only_estimated_delivery, $page, $page_size): \OpenAPI\Client\Model\CampaignsCampaignIdOrders
```
...
```php
getOutlet($campaign_id, $outlet_id): \OpenAPI\Client\Model\CampaignsCampaignIdOutletsOutletId
```
...
```php
getOutlets($campaign_id, $page_token, $region_id, $shop_outlet_code, $region_id2): \OpenAPI\Client\Model\CampaignsCampaignIdOutlets
```
...
```php
getReturn($campaign_id, $order_id, $return_id): \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnId
```
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnId**](../Model/CampaignsCampaignIdOrdersOrderIdReturnsReturnId.md)
...
```php
getReturns($campaign_id, $page_token, $limit, $order_ids, $statuses, $type, $from_date, $to_date, $from_date2, $to_date2): \OpenAPI\Client\Model\CampaignsCampaignIdReturns
```
...
| **statuses** | [**\OpenAPI\Client\Model\CampaignsCampaignIdReturns[]**](../Model/\OpenAPI\Client\Model\CampaignsCampaignIdReturns.md)| Статусы возвратов или невыкупов — для фильтрации результатов.  Возможные значения:  * CREATED — возврат создан.  * RECEIVED — принят у покупателя.  * IN_TRANSIT — возврат в пути.  * READY_FOR_PICKUP — возврат готов к выдаче магазину.  * PICKED — возврат выдан магазину.  * LOST — возврат утерян при транспортировке.  * CANCELLED — возврат отменен.  * EXPIRED — возврат просрочен, покупатель не передал товар.  * FULFILMENT_RECEIVED — возврат принят на складе Маркета.  * PREPARED_FOR_UTILIZATION — возврат передан в утилизацию.  * UTILIZED — возврат утилизирован.  Несколько статусов перечисляются через запятую. | [optional] |
| **type** | [**CampaignsCampaignIdReturns**](../Model/.md)| Тип заказа для фильтрации:  * RETURN — возврат.  * UNREDEEMED — невыкуп.  Если не указывать, в ответе будут и возвраты, и невыкупы. | [optional] |
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdReturns**](../Model/CampaignsCampaignIdReturns.md)
...
```php
provideOrderDigitalCodes($campaign_id, $order_id, $body): \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliverDigitalGoods
```

Передача ключей цифровых товаров

Передает ключи цифровых товаров, которые покупатель заказал и оплатил. После выполнения запроса Маркет отправит ему письмо с ключами и инструкциями по активации, а также переведет заказ в финальный статус `DELIVERED`.  Методом можно воспользоваться после перехода заказа в статус `PROCESSING`.  Если в один заказ входят несколько ключей, передавайте их все в одном запросе.  |**⚙️ Лимит:** 1 000 000 запросов в час| |-|
...
$campaign_id = 56; // int | Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**.
$order_id = 56; // int | Идентификатор заказа.
$body = new \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliverDigitalGoods(); // \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliverDigitalGoods

try {
    $result = $apiInstance->provideOrderDigitalCodes($campaign_id, $order_id, $body);
    print_r($result);
} catch (Exception $e) {
...
| **campaign_id** | **int**| Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. | |
| **order_id** | **int**| Идентификатор заказа. | |
| **body** | **\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliverDigitalGoods**|  | |

### Return type

[**\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliverDigitalGoods**](../Model/CampaignsCampaignIdOrdersOrderIdDeliverDigitalGoods.md)
...
```php
provideOrderItemIdentifiers($campaign_id, $order_id, $body): \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdIdentifiers
```
...
$campaign_id = 56; // int | Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**.
$order_id = 56; // int | Идентификатор заказа.
$body = new \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdIdentifiers(); // \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdIdentifiers

try {
    $result = $apiInstance->provideOrderItemIdentifiers($campaign_id, $order_id, $body);
    print_r($result);
} catch (Exception $e) {
...
| **campaign_id** | **int**| Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. | |
| **order_id** | **int**| Идентификатор заказа. | |
| **body** | **\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdIdentifiers**|  | |

### Return type

[**\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdIdentifiers**](../Model/CampaignsCampaignIdOrdersOrderIdIdentifiers.md)
...
```php
setOrderShipmentBoxes($campaign_id, $order_id, $shipment_id, $body): \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliveryShipmentsShipmentIdBoxes
```
...
$body = new \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliveryShipmentsShipmentIdBoxes(); // \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliveryShipmentsShipmentIdBoxes

try {
    $result = $apiInstance->setOrderShipmentBoxes($campaign_id, $order_id, $shipment_id, $body);
    print_r($result);
} catch (Exception $e) {
...
| **body** | **\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliveryShipmentsShipmentIdBoxes**|  | |

### Return type

[**\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliveryShipmentsShipmentIdBoxes**](../Model/CampaignsCampaignIdOrdersOrderIdDeliveryShipmentsShipmentIdBoxes.md)
...
```php
setReturnDecision($campaign_id, $order_id, $return_id, $body): \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision
```
...
$order_id = 56; // int | Идентификатор заказа.
$return_id = 56; // int | Идентификатор возврата
$body = new \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision(); // \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision

try {
    $result = $apiInstance->setReturnDecision($campaign_id, $order_id, $return_id, $body);
    print_r($result);
} catch (Exception $e) {
...
| **order_id** | **int**| Идентификатор заказа. | |
| **return_id** | **int**| Идентификатор возврата | |
| **body** | **\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision**|  | |

### Return type

[**\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision**](../Model/CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision.md)
...
```php
submitReturnDecision($campaign_id, $order_id, $return_id): \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecisionSubmit
```
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecisionSubmit**](../Model/CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecisionSubmit.md)
...
```php
updateOrderItems($campaign_id, $order_id, $body)
```
...
$campaign_id = 56; // int | Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**.
$order_id = 56; // int | Идентификатор заказа.
$body = new \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdItems(); // \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdItems

try {
    $apiInstance->updateOrderItems($campaign_id, $order_id, $body);
} catch (Exception $e) {
...
| **campaign_id** | **int**| Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. | |
| **order_id** | **int**| Идентификатор заказа. | |
| **body** | **\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdItems**|  | |
...
```php
updateOrderStatuses($campaign_id, $body): \OpenAPI\Client\Model\CampaignsCampaignIdOrdersStatusUpdate
```
...
$campaign_id = 56; // int | Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**.
$body = new \OpenAPI\Client\Model\CampaignsCampaignIdOrdersStatusUpdate(); // \OpenAPI\Client\Model\CampaignsCampaignIdOrdersStatusUpdate

try {
    $result = $apiInstance->updateOrderStatuses($campaign_id, $body);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **campaign_id** | **int**| Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. | |
| **body** | **\OpenAPI\Client\Model\CampaignsCampaignIdOrdersStatusUpdate**|  | |

### Return type

[**\OpenAPI\Client\Model\CampaignsCampaignIdOrdersStatusUpdate**](../Model/CampaignsCampaignIdOrdersStatusUpdate.md)
...
```php
updateOutlet($campaign_id, $outlet_id, $body): \OpenAPI\Client\Model\CampaignsCampaignIdOutletsOutletId
```
...
$campaign_id = 56; // int | Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**.
$outlet_id = 56; // int | Идентификатор точки продаж
$body = new \OpenAPI\Client\Model\CampaignsCampaignIdOutletsOutletId(); // \OpenAPI\Client\Model\CampaignsCampaignIdOutletsOutletId

try {
    $result = $apiInstance->updateOutlet($campaign_id, $outlet_id, $body);
    print_r($result);
} catch (Exception $e) {
...
| **campaign_id** | **int**| Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. | |
| **outlet_id** | **int**| Идентификатор точки продаж | |
| **body** | **\OpenAPI\Client\Model\CampaignsCampaignIdOutletsOutletId**|  | |
