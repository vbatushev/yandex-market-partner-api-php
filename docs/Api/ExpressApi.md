...
```php
getOrderLabelsData($campaign_id, $order_id): \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliveryLabelsData
```
...
[**\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdDeliveryLabelsData**](../Model/CampaignsCampaignIdOrdersOrderIdDeliveryLabelsData.md)
