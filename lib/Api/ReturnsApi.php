...
/**
     ...
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  int $return_id Идентификатор возврата (required)
     * @param  \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision $body body (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse
     */
    public function setReturnDecision($campaign_id, $order_id, $return_id, $body, string $contentType = self::contentTypes['setReturnDecision'][0])
    {
        list($response) = $this->setReturnDecisionWithHttpInfo($campaign_id, $order_id, $return_id, $body, $contentType);
        return $response;
    }
     ...
     * @param  int $order_id Идентификатор заказа. (required)
     * @param  int $return_id Идентификатор возврата (required)
     * @param  \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setReturnDecision'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function setReturnDecisionWithHttpInfo($campaign_id, $order_id, $return_id, $body, string $contentType = self::contentTypes['setReturnDecision'][0])
    {
        $request = $this->setReturnDecisionRequest($campaign_id, $order_id, $return_id, $body, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setReturnDecisionAsync($campaign_id, $order_id, $return_id, $body, string $contentType = self::contentTypes['setReturnDecision'][0])
    {
        return $this->setReturnDecisionAsyncWithHttpInfo($campaign_id, $order_id, $return_id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setReturnDecisionAsyncWithHttpInfo($campaign_id, $order_id, $return_id, $body, string $contentType = self::contentTypes['setReturnDecision'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecision';
        $request = $this->setReturnDecisionRequest($campaign_id, $order_id, $return_id, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setReturnDecisionRequest($campaign_id, $order_id, $return_id, $body, string $contentType = self::contentTypes['setReturnDecision'][0])
    {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling setReturnDecision'
            );
        }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecisionSubmit|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse
     */
    ...
    public function submitReturnDecisionWithHttpInfo($campaign_id, $order_id, $return_id, string $contentType = self::contentTypes['submitReturnDecision'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecisionSubmit' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecisionSubmit' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecisionSubmit', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecisionSubmit';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CampaignsCampaignIdOrdersOrderIdReturnsReturnIdDecisionSubmit',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
