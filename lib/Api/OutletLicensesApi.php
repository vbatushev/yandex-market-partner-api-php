...
/**
    ...
    public function deleteOutletLicensesWithHttpInfo($campaign_id, $ids = null, string $contentType = self::contentTypes['deleteOutletLicenses'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CampaignsCampaignIdOutletsLicenses' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CampaignsCampaignIdOutletsLicenses' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CampaignsCampaignIdOutletsLicenses', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdOutletsLicenses';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CampaignsCampaignIdOutletsLicenses',
     ...
     *
     * @param  int $campaign_id Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. (required)
     * @param  \OpenAPI\Client\Model\CampaignsCampaignIdOutletsLicenses $body body (required)
     ...
     * @return \OpenAPI\Client\Model\CampaignsCampaignIdOutletsLicenses|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse
     */
    public function updateOutletLicenses($campaign_id, $body, string $contentType = self::contentTypes['updateOutletLicenses'][0])
    {
        list($response) = $this->updateOutletLicensesWithHttpInfo($campaign_id, $body, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $campaign_id Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. (required)
     * @param  \OpenAPI\Client\Model\CampaignsCampaignIdOutletsLicenses $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateOutletLicenses'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CampaignsCampaignIdOutletsLicenses|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOutletLicensesWithHttpInfo($campaign_id, $body, string $contentType = self::contentTypes['updateOutletLicenses'][0])
    {
        $request = $this->updateOutletLicensesRequest($campaign_id, $body, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOutletLicensesAsync($campaign_id, $body, string $contentType = self::contentTypes['updateOutletLicenses'][0])
    {
        return $this->updateOutletLicensesAsyncWithHttpInfo($campaign_id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOutletLicensesAsyncWithHttpInfo($campaign_id, $body, string $contentType = self::contentTypes['updateOutletLicenses'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdOutletsLicenses';
        $request = $this->updateOutletLicensesRequest($campaign_id, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateOutletLicensesRequest($campaign_id, $body, string $contentType = self::contentTypes['updateOutletLicenses'][0])
    {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateOutletLicenses'
            );
        }
