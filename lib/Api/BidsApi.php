...
/**
     ...
     * @param  \OpenAPI\Client\Model\CampaignsCampaignIdBids $body description (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CampaignsCampaignIdBids|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse
     */
    public function putBidsForCampaign($campaign_id, $body, string $contentType = self::contentTypes['putBidsForCampaign'][0])
    {
        list($response) = $this->putBidsForCampaignWithHttpInfo($campaign_id, $body, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\CampaignsCampaignIdBids|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function putBidsForCampaignWithHttpInfo($campaign_id, $body, string $contentType = self::contentTypes['putBidsForCampaign'][0])
    {
        $request = $this->putBidsForCampaignRequest($campaign_id, $body, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CampaignsCampaignIdBids' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CampaignsCampaignIdBids' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CampaignsCampaignIdBids', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdBids';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CampaignsCampaignIdBids',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putBidsForCampaignAsync($campaign_id, $body, string $contentType = self::contentTypes['putBidsForCampaign'][0])
    {
        return $this->putBidsForCampaignAsyncWithHttpInfo($campaign_id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putBidsForCampaignAsyncWithHttpInfo($campaign_id, $body, string $contentType = self::contentTypes['putBidsForCampaign'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdBids';
        $request = $this->putBidsForCampaignRequest($campaign_id, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putBidsForCampaignRequest($campaign_id, $body, string $contentType = self::contentTypes['putBidsForCampaign'][0])
    {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling putBidsForCampaign'
            );
        }
