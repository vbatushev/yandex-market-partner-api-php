...
/**
     ...
     * @param  \OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdConfirm $body body (required)
     ...
     * @return \OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdConfirm|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse
     */
    public function confirmShipment($campaign_id, $shipment_id, $body, string $contentType = self::contentTypes['confirmShipment'][0])
    {
        list($response) = $this->confirmShipmentWithHttpInfo($campaign_id, $shipment_id, $body, $contentType);
        return $response;
    }
     ...
     * @param  int $campaign_id Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. (required)
     * @param  int $shipment_id Идентификатор отгрузки. (required)
     * @param  \OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdConfirm $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['confirmShipment'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function confirmShipmentWithHttpInfo($campaign_id, $shipment_id, $body, string $contentType = self::contentTypes['confirmShipment'][0])
    {
        $request = $this->confirmShipmentRequest($campaign_id, $shipment_id, $body, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdConfirm' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdConfirm' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdConfirm', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdConfirm';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdConfirm',
     ...
     */
    public function confirmShipmentAsync($campaign_id, $shipment_id, $body, string $contentType = self::contentTypes['confirmShipment'][0])
    {
        return $this->confirmShipmentAsyncWithHttpInfo($campaign_id, $shipment_id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function confirmShipmentAsyncWithHttpInfo($campaign_id, $shipment_id, $body, string $contentType = self::contentTypes['confirmShipment'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdConfirm';
        $request = $this->confirmShipmentRequest($campaign_id, $shipment_id, $body, $contentType);
     ...
     */
    public function confirmShipmentRequest($campaign_id, $shipment_id, $body, string $contentType = self::contentTypes['confirmShipment'][0])
    {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentId|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse
     */
    ...
    public function getShipmentWithHttpInfo($campaign_id, $shipment_id, string $contentType = self::contentTypes['getShipment'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentId' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentId' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentId', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentId';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdOrdersInfo|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse
     */
    ...
    public function getShipmentOrdersInfoWithHttpInfo($campaign_id, $shipment_id, string $contentType = self::contentTypes['getShipmentOrdersInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdOrdersInfo' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdOrdersInfo' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdOrdersInfo', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdOrdersInfo';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipmentsShipmentIdOrdersInfo',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $campaign_id Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. (required)
     * @param  \OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipments $body body (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipments|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse
     */
    public function searchShipments($campaign_id, $body, $page_token = null, $limit = null, string $contentType = self::contentTypes['searchShipments'][0])
    {
        list($response) = $this->searchShipmentsWithHttpInfo($campaign_id, $body, $page_token, $limit, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $campaign_id Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. (required)
     * @param  \OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipments $body (required)
     * @param  string $page_token Идентификатор страницы c результатами.  Если параметр не указан, возвращается самая старая страница.  Рекомендуется передавать значение выходного параметра &#x60;nextPageToken&#x60;, полученное при последнем запросе.  Если задан &#x60;page_token&#x60;, параметры &#x60;offset&#x60;, &#x60;page_number&#x60; и &#x60;page_size&#x60; игнорируются. (optional)
     * @param  int $limit Количество товаров в выходных данных. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchShipments'] to see the possible values for this operation
     *
     ...
     * @return array of \OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipments|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchShipmentsWithHttpInfo($campaign_id, $body, $page_token = null, $limit = null, string $contentType = self::contentTypes['searchShipments'][0])
    {
        $request = $this->searchShipmentsRequest($campaign_id, $body, $page_token, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipments' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipments' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipments', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipments';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipments',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchShipmentsAsync($campaign_id, $body, $page_token = null, $limit = null, string $contentType = self::contentTypes['searchShipments'][0])
    {
        return $this->searchShipmentsAsyncWithHttpInfo($campaign_id, $body, $page_token, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchShipmentsAsyncWithHttpInfo($campaign_id, $body, $page_token = null, $limit = null, string $contentType = self::contentTypes['searchShipments'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CampaignsCampaignIdFirstMileShipments';
        $request = $this->searchShipmentsRequest($campaign_id, $body, $page_token, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchShipmentsRequest($campaign_id, $body, $page_token = null, $limit = null, string $contentType = self::contentTypes['searchShipments'][0])
    {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling searchShipments'
            );
        }
